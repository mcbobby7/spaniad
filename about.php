...
<div class='message' id="single">
	...
	<div style="text-align: left;">
		...
		<h5>At E&L, LLP, we are committed to providing exceptional legal counsel in the area of family law. Our clients would include business owners, homemakers, blue collar workers, athletes, business leaders and professionals.</h5>

<h5>The firm's philosophy of service is based on the following principles:</h5>
<ul>
<li> Provide quality and professional legal service</li>
 <li>Maintain communication and accessibility</li>
 <li>Respond promptly</li>
<li> Get the best possible results with the least animosity</li>
 <li>Respect confidences</li>
<li> Negotiate when possible</li>
 <li>Litigate when necessary</li>
</ul>

<h5>At E&L, LLP we strive for amicable resolutions to family law disputes. However, we have the expertise to litigate aggressively when necessary, and our clients can rely on our abilities in the courtroom and reputation to advocate rightfully.</h5>

<h3 style="color: green; text-align: center;">THE ETHOS OF THE E&L, LLP:</h3>
<h5>Our ethos is premised upon the following standards:
<ol>
<li> Satisfaction of clientele by living up to their expectations, delivering unparalleled legal services, and a commitment to their struggles;</li>
<li> Excellence in legal performance by maintaining up-to-date legal reviews and continuing education;</li>
<li> Active commitment to success in fulfilling promises, while leaving an open channel of communication with clientele;</li>
<li> Maintaining an oriented firm where clients are not just clients, but are a family member; and</li>
<li> Community involvement by pro bono services.</li>
</ol>
</h5>

<h5><span style="color: red;">Contact us today</span> to schedule an appointment for your free consultation regarding your family law matter, and determine how we may be able to assist you.</h5>

<h3 style="color: green; text-align: center;">DISTINGUISHED PRACTICE</h3>
<h5>At E&L LLP, we pride ourselves in delivering the attentiveness that is the cornerstone of large-firm services. We believe that extraordinary determination leads to extraordinary results. Here, you are not just a case…you are a client.</h5>
</div>
